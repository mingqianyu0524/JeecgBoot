<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="800" @ok="handleSubmit">
    <client-management-form ref="formComponent" :formDisabled="formDisabled" :formBpm="false" @success="submitSuccess"></client-management-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import ClientManagementForm from './ClientManagementForm.vue';
