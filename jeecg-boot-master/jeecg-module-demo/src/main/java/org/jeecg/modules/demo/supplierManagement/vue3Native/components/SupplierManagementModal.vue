<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="800" @ok="handleSubmit">
    <supplier-management-form ref="formComponent" :formDisabled="formDisabled" :formBpm="false" @success="submitSuccess"></supplier-management-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import SupplierManagementForm from './SupplierManagementForm.vue';
