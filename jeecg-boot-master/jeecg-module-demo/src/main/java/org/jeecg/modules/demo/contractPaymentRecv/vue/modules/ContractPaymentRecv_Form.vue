  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="付款流水号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="paymentSerialNumber">
              <a-input v-model="model.paymentSerialNumber" placeholder="请输入付款流水号" disabled ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
