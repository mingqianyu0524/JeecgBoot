package org.jeecg.modules.demo.supplierManagement.vo;
...
public class SupplierManagementPage {
	...
	/**联系人*/
	@Excel(name = "联系人", width = 15, dictTable = "supplier_contact", dicText = "name", dicCode = "name")
    @Dict(dictTable = "supplier_contact", dicText = "name", dicCode = "name")
