  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24" >
            <a-form-model-item label="客户编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="clientIndex">
              <a-input-number v-model="model.clientIndex" placeholder="请输入客户编号" style="width: 100%" disabled/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
          ...
          <a-col :span="24" >
            <a-form-model-item label="联系人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="contact">
              <j-search-select-tag v-model="model.contact" dict="client_contact,name,name" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
