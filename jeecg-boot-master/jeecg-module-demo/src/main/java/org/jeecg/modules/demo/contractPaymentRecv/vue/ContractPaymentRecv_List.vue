        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="合同编号">
              <j-popup placeholder="请选择合同编号" v-model="queryParam.contractIndex" code="select_all_contracts" org-fields="contract_index,contract_name,id,project_index,project_name" dest-fields="contract_index,contract_name,contract_fk_id,project_index,project_name" :field="getPopupField('contract_index,contract_name,contract_fk_id,project_index,project_name')" :multi="true"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
