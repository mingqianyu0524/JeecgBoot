  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24" >
            <a-form-model-item label="供应商编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="supplierIndex">
              <a-input-number v-model="model.supplierIndex" placeholder="请输入供应商编号" style="width: 100%" disabled/>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
          ...
          <a-col :span="24" >
            <a-form-model-item label="联系人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="contact">
              <j-search-select-tag v-model="model.contact" dict="supplier_contact,name,name" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
    ...
    <a-tabs v-model="activeKey" @change="handleChangeTabs">
      <a-tab-pane tab="供应商联系人" :key="refKeys[0]" :forceRender="true">
        <j-vxe-table
          keep-source
          :ref="refKeys[0]"
  ...
  export default {
    ...
    data() {
      return {
        ...
        refKeys: ['supplierContact', ],
        tableKeys:['supplierContact', ],
        activeKey: 'supplierContact',
        // 供应商联系人
        ...
        url: {
          add: "/supplierManagement/supplierManagement/add",
          edit: "/supplierManagement/supplierManagement/edit",
          queryById: "/supplierManagement/supplierManagement/queryById",
          supplierContact: {
            list: '/supplierManagement/supplierManagement/querySupplierContactByMainId'
          },
        }
      }
    },
    ...
    methods: {
      addBefore(){
        this.supplierContactTable.dataSource=[]
      },
      getAllTable() {
      ...
      editAfter() {
        ...
        if (this.model.id) {
          ...
          this.requestSubTableData(this.url.supplierContact.list, params, this.supplierContactTable)
        }
      },
      //校验所有一对一子表表单
      ...
      classifyIntoFormData(allValues) {
        ...
        return {
          ...main, // 展开
          supplierContactList: allValues.tablesValue[0].tableData,
        }
      },
      validateError(msg){
