    ...
    <j-form-container :disabled="formDisabled">
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24" >
            <a-form-model-item label="合同周期" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="contractStartDate">
              <j-date placeholder="请选择合同开始时间" v-model="model.contractStartDate" style="width: 50%" />
              <j-date placeholder="请选择合同结束时间" v-model="model.contractEndDate" style="width: 50%" />
            </a-form-model-item>
          </a-col>
<!--          <a-col :span="24" >-->
<!--            <a-form-model-item label="合同周期" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="contractPeriod">-->
<!--              <a-range-picker v-model="contractPeriod" style="width:100%" />-->
<!--            </a-form-model-item>-->
<!--          </a-col>-->
          <a-col :span="24" >
          ...
          <a-col :span="24" >
            <a-form-model-item label="合同扫描件" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="contractScannedString">
              <j-image-upload isMultiple  v-model="model.contractScannedString" ></j-image-upload>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
  ...
  export default {
    ...
    data() {
      return {
        ...
        // dateRange: {
        //   contractPeriod: ref<[Dayjs, Dayjs]>(),
        // },
        model:{
        ...
        refKeys: ['contractPaymentTerm', 'contractPaymentRecv', 'operationLog'],
        tableKeys:['contractPaymentTerm', 'contractPaymentRecv', 'operationLog'],
        ...
        url: {
          ...
          operationLog: {
            list: '/contractManagement/contractManagement/queryOperationLog'
          },
        }
      }
    },
