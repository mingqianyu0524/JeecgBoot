<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleDownloadTemplate('供应商管理')">下载模板</a-button>
      <!-- 高级查询区域 -->
    ...
    <supplier-management-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
<script>
  ...
  import SupplierManagementModal from './modules/SupplierManagementModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          delete: "/supplierManagement/supplierManagement/delete",
          deleteBatch: "/supplierManagement/supplierManagement/deleteBatch",
          exportXlsUrl: "/supplierManagement/supplierManagement/exportXls",
          downTemplate: "/supplierManagement/supplierManagement/downTemplate",
          importExcelUrl: "supplierManagement/supplierManagement/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'int',value:'supplierIndex',text:'供应商编号',dictCode:''})
        fieldList.push({type:'string',value:'supplierName',text:'供应商名称',dictCode:''})
        fieldList.push({type:'pca',value:'city',text:'所在城市'})
        fieldList.push({type:'sel_search',value:'contact',text:'联系人',dictTable:"supplier_contact", dictText:'name', dictCode:'name'})
