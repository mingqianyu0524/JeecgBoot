...
export function getRefPromise(vm, name) {
  console.log('getting ref promise')
...
export function validateTables(cases, autoJumpTab = true) {
  ...
  return new Promise((resolve, reject) => {
    ...
    (function next() {
      let vm = cases[index]
      // 特殊情况：view model为vue object
      // if (vm.hasOwnProperty('columns') && vm.hasOwnProperty('dataSource') && vm.hasOwnProperty('loading')) {
      //   tablesData[index] = vm.dataSource
      //   index++
      //   next()
      // }
      // vm = cases[index]
